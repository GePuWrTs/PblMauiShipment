...
namespace PblMauiShipment.ViewModels
{
    ...
    public partial class RackScanRegisterViewModel : BaseViewModel
    {
        ...
        [RelayCommand]
        void DeleteRackScannRegister(RackScan rackScan)
        {
            if (rackScan == null)
            {
                return;
            ...
            if (RackScannsRegister.Remove(rackScan))
            {
                if (zxingBarcodeStrRegisterOld == rackScan.Barcode)
                {
                    zxingBarcodeStrRegisterOld = string.Empty;
                }

                SaveRackScanJsonRegister();
            }
        }
